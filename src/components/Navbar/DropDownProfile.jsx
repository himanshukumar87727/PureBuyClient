...
export default function DropDownProfile() {
  const profileMenu = [
    { name: 'Your Profile', href: '#', icon: <FaUserAlt className='text-purple-900' /> },
    { name: 'Settings', href: '#', icon: <IoMdSettings className='text-gray-700' /> },
    { name: 'Sign out', href: '#', icon: <FaSignOutAlt className='text-yellow-700' /> },
  ];
